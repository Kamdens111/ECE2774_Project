...
sim1.add_conductor("Finch", 0.0435, 0.0969, 1.293, "geo1")

sim1.add_bus("bus3", 230e3)
sim1.add_bus("bus4", 230e3)
sim1.add_bus("bus5", 230e3)
sim1.add_bus("bus6", 230e3)
sim1.add_bus("bus7", 18e3)

sim1.add_transmissionLine("tline1", 10, "Finch", "bus2", "bus4")
sim1.add_transmissionLine("tline2", 25, "Finch", "bus2", "bus3")
sim1.add_transmissionLine("tline3", 20, "Finch", "bus3", "bus5")
sim1.add_transmissionLine("tline4", 20, "Finch", "bus4", "bus6")
sim1.add_transmissionLine("tline5", 10, "Finch", "bus5", "bus6")
sim1.add_transmissionLine("tline6", 35, "Finch", "bus4", "bus5")
